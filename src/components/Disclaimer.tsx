  ...
  if (!isVisible) {
    return (
      <button
        ...
        className="fixed bottom-4 right-4 z-40 w-10 h-10 rounded-full bg-[var(--warning)]/20 border border-[var(--warning)]/30 flex items-center justify-center text-[var(--warning)] hover:bg-[var(--warning)]/30 transition-colors"
